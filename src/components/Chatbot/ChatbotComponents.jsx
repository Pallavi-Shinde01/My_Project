...
import React, { useState, useEffect, useRef } from "react";  //useState-var chya value store krun thevnyasath use ktat
...
const ChatbotComponent = () => {
  ...
  const [loading, setLoading] = useState(false);  //blue-var & yellow-fun
  ...
  useEffect(() => {
    const prepareKB = async () => {   //asnyc-asyncronus
      const newKB = JSON.parse(JSON.stringify(KNOWLEDGE_BASE_DATA)); // Create a deep copy of KNOWLEDGE_BASE_DATA & showlow copy mde canges copy kele dist nahit
